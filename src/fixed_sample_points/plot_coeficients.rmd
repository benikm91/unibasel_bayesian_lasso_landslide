...
for (site in sites) {
    print(site)
    coefs.frequentist.lauren[[site]] <- read.fst(str_interp('res/coef/freq_24_5_22/${site}_coef_frequentist.block.lauren.fst'))
    coefs.bayesian.lauren[[site]] <- read.fst(str_interp('res/coef/freq_24_5_22/${site}_coef_bayesian.lauren.fst'))
}
