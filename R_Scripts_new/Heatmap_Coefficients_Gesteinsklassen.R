...
table.coef <- head(read.table( paste("/Users/beni/Documents/BayianLasso/data/data/out/Arosa/Arosa.model.1.Gestkl.coeffiecients_cv_grpreg_grLasso_1_1.txt", sep="") ,
...
for ( i in 1:n.folds ) {
  for ( j in 1:k.boot ) {
    ...
    table.coef <- head(read.table( paste("/Users/beni/Documents/BayianLasso/data/data/out/Arosa/Arosa.model.1.Gestkl.coeffiecients_cv_grpreg_grLasso_",i,"_",j,".txt", sep="") ,
                                   stringsAsFactors=FALSE, row.names=NULL, dec=".", fill=TRUE, flush=TRUE, header = TRUE, skip=1), -4)
