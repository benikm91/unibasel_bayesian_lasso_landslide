...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Arosa/Arosa.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Arosa <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Arosa)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Arosa/Arosa.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Baulmes/Baulmes.model.2.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Baulmes <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Baulmes)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Baulmes/Baulmes.model.2.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Chrauchtal/Chrauchtal.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Chrauchtal <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Chrauchtal)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Chrauchtal/Chrauchtal.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Hornbach/Hornbach.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Hornbach <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Hornbach)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Hornbach/Hornbach.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Rappetal/Rappetal.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Rappetal <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Rappetal)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Rappetal/Rappetal.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Turbach/Turbach.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Turbach <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Turbach)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Turbach/Turbach.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Urseren/Urseren.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Urseren <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Urseren)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Urseren/Urseren.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Val_Cluozza/Val_Cluozza.model.2.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Val_Cluozza <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Val_Cluozza)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Val_Cluozza/Val_Cluozza.model.2.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Val_D_Entremont/Val_D_Entremont.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Val_D_Entremont <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Val_D_Entremont)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Val_D_Entremont/Val_D_Entremont.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
for ( j in 1:k.boot ) {
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Val_Piora/Val_Piora.model.1.no.corine.cv.grpreg_grLasso_',j,'.rda', sep=""))
  grpreg.model.Val_Piora <- as.numeric(cv.grpreg)
  grpreg.model <- c(grpreg.model, grpreg.model.Val_Piora)
  load (paste('/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Val_Piora/Val_Piora.model.1.no.corine.lslpts.observations_',j,'.rda', sep=""))
...
sink("/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/Brier_Scores_grlasso_no_bootstrap_noCorine.txt")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/bootstrapped_BS_all_Sites_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Arosa_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Baulmes_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Chrauchtal_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Hornbach_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Rappetal_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Turbach_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Urseren_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Val_Cluozza_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Val_D_Entremont_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_Val_Piora_noCorine.pdf")
...
pdf(file="/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/AUC_ROC/ROC_AUC_All_in_One_Plot_noCorine.pdf")
par(cex.axis=1.3)
...
sink("/Volumes/Lauren_Uni/M3_SSGM/R_Modelling/Model_Scores/Contingency_Table_results_noCorine.txt")
